// src/components/HistorialPatologico.tsx
'use client';
...
interface HistorialPatologicoProps {
  onAddHistorial: (historial: string) => void;
  historial: string[];
  onRemoveHistorial: (index: number) => void; // Nueva prop para eliminar historial
}

const HistorialPatologico: React.FC<HistorialPatologicoProps> = ({ onAddHistorial, historial, onRemoveHistorial }) => {
  ...
  return (
    <Paper sx={{ padding: 2, borderRadius: 2 }}>
      <Typography color='success' variant="h6" sx={{ mb: 2 }}>Historial Patológico</Typography>
      <TextField
        fullWidth
        label="Agregar historial patológico"
...
export default HistorialPatologico;