...
import EvaluacionesNutricionalesDeleteForm from './components/EvaluacionesNutricionalesDeleteForm';

const EvaluacionesNutricionalesDeletePage = () => {
    ...
    return (
        ...
        <EvaluacionesNutricionalesLayout>
            <div>
                <HeaderUser title="Evaluaciones Nutricionales ~ Eliminacion de Evaluaciones" />
                
                <Box sx={{ display: 'flex' }}>
                    <Box sx={{ flex: 1, mt: 24, mr: 2 }}>
                        <EvaluacionesNutricionalesDeleteForm 
...
export default EvaluacionesNutricionalesDeletePage;