...
import HistorialClinicoDeleteForm from "./components/HistorialClinicoDeleteForm";
 



const HistorialClinicoDeletePage = () => {
    ...
    return (
        <ProtectedRoute>
            <HistorialClinicoLayout>
                <div>
                    <HeaderUser title="Historiales Clinicos ~ Eliminacion de Historiales" />
                    <Box sx={{ display: 'flex' }}>
                        <Box sx={{ flex: 1, mt: 21, mr: 2 }}>
                        <HistorialClinicoDeleteForm 
...
export default HistorialClinicoDeletePage;