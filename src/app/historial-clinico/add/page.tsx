...
import HistorialClinicoForm from "./components/HistorialClinicoForm"; // Verifica que esta ruta sea correcta
                ...
                <div>
                    ...
                    <Box sx={{ display: 'flex' }}>
                        ...
                        <HistorialClinicoForm 
                            ...
                            rup={rup} // Asegúrate de que aquí se pase el estado de rup
                            onRupChange={handleRupChange} // Asegúrate de que esta función esté definida
                            idMedico={0} 
                            onIdMedicoChange={function (id: number): void {
...
export default HistorialClinicoAddPage;